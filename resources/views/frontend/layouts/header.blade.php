                ...
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        @php
                            ...
                            <li><i class="ti-info-alt"></i> @foreach($settings as $data) {{$data->email}} @endforeach</li>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='home' ? 'active' : ''}}"><a style="color:#001e63" href="{{route('about-us')}}">About Us</a></li>
                                            ...
                                            <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a style="color:#001e63" href="{{route('contact')}}">Contact Us</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
